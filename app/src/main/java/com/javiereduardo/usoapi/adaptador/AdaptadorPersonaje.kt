...
import com.example.usoapi.ActivityDetalles
...
class AdaptadorPersonaje(personajes:ArrayList<Personaje>, ctx:Context): RecyclerView.Adapter<AdaptadorPersonaje.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val vistaPersonaje = LayoutInflater.from(ctx).inflate(R.layout.layout_personaje,parent,false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.ibDetalle.setOnClickListener {
            val i =Intent(ctx,ActivityDetalles::class.java)
